  ...
  describe '#cumulative_price' do
    context 'When Lodging is a OpenGDS Hotel' do
      ...
      context 'When Rate Type = \'Per Stay\'' do
        let(:rate_plan) { create(:rate_plan_with_child_rates_and_rule, open_gds_rate_type: 3, open_gds_single_rate_type: 0, min_stay: 3, max_stay: 3, categories: [1, 2], rates: [10, 20], lodging_id: parent_lodging.id) }
      ...
      context 'When Rate Type = \'Per Person\'' do
        let(:rate_plan) { create(:rate_plan_with_child_rates_and_rule, open_gds_rate_type: 2, open_gds_single_rate_type: 0, min_stay: 3, max_stay: 3, categories: [1, 2], rates: [10, 20], lodging_id: parent_lodging.id) }
      ...
      context "When Rate Type = \'Per Person Per Night\'" do
        let(:rate_plan) { create(:rate_plan_with_child_rates_and_rule, open_gds_rate_type: 0, open_gds_single_rate_type: 0, min_stay: 1, max_stay: 3, categories: [1, 2], rates: [10, 20], lodging_id: parent_lodging.id) }
      ...
      context "When Rate Type = \'Per Person Per Day\'" do
        let(:rate_plan) { create(:rate_plan_with_child_rates_and_rule, open_gds_rate_type: 4, open_gds_single_rate_type: 0, min_stay: 1, max_stay: 3, categories: [1, 2], rates: [10, 20], lodging_id: parent_lodging.id) }
      ...
      context "When Rate Type = \'Per Accommodation Per Night\'" do
        let(:rate_plan) { create(:rate_plan_with_child_rates_and_rule, open_gds_rate_type: 1, open_gds_single_rate_type: 0, min_stay: 1, max_stay: 3, categories: [1, 2], rates: [10, 20], lodging_id: parent_lodging.id) }
      ...
      context "When Rate Type = \'Per Accommodation Per Day\'" do
        let(:rate_plan) { create(:rate_plan_with_child_rates_and_rule, open_gds_rate_type: 5, open_gds_single_rate_type: 0, min_stay: 1, max_stay: 3, categories: [1, 2], rates: [10, 20], lodging_id: parent_lodging.id) }
