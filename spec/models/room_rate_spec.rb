...
RSpec.describe RoomRate, type: :model do
  describe '#cumulative_price' do
    ...
    it 'should return price for only 1 adult for rate plan with Rate Type = \'Per Stay\' and Single Rate Type = \'Single Supplement\'' do
    ...
    it 'should return price for only 1 adult for rate plan with Rate Type = \'Per Stay\' and Single Rate Type = \'Single Rate\'' do
