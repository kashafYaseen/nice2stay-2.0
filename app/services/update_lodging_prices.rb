class UpdateLodgingPrices
  ...
  private
    ...
    def create_rule(from, to, minimal_stay, flexible_arrival, checkin_day)
      ...
      from = from.to_date.change(year: 2021) if [20021, 202121, 0201, 0221].include?(from.to_date.year)
      to = to.to_date.change(year: 2021) if [20021, 202121, 0201, 0221].include?(to.to_date.year)
    ...
    def end_date
      return '31-12-2024'.to_date if 365.days.from_now < '31-12-2024'.to_date
      365.days.from_now
    end
end
