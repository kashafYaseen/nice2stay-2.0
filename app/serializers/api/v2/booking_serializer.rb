class Api::V2::BookingSerializer
  ...
  attributes :id, :confirmed, :created_at, :identifier, :pre_payment, :pre_payment_amount,
             :final_payment, :final_payment_amount, :pre_payed_at, :final_payed_at, :total_security_deposit, :total_security_deposit_on_location, :security_payed_at, :booking_status, :canceled, :total_payment
