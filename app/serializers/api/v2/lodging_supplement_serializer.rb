class Api::V2::LodgingSupplementSerializer
  ...
  attribute :supplements, if: proc { |lodging| !lodging.belongs_to_channel? } do |lodging, params|
    ...
    Api::V2::SupplementSerializer.new(supplements.applied_lodgings_supplements(params[:check_in], params[:check_out], params[:guests], ((lodging.as_standalone? && :lodging) || :linked_lodgings)).published, params: params)
  end
