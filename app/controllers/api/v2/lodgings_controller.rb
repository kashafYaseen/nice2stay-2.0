class Api::V2::LodgingsController < Api::V2::ApiController
  ...
  def cumulative_price
    ...
    render json: Api::V2::CumulativePriceSerializer.new(lodgings, { params: { check_in: params[:check_in], check_out: params[:check_out], adults: params[:adults].to_i, children: params[:children].to_i, supplements: supplements, accom_listing: params[:accom_listing], show_supplements: params[:show_supplements] }}).serialized_json, status: :ok
  end
