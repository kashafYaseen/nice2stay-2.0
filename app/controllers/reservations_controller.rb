class ReservationsController < ApplicationController
  ...
  def validate
    ...
    @reservation = @booking.reservations.unexpired.build(check_in: values[0], check_out: values[1], adults: values[2], children: values[3], infants: values[4], lodging_id: values[5], base_error: values[6])
  end
