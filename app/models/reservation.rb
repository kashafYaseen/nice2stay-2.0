class Reservation < ApplicationRecord
  ...
  private
    ...
    def no_of_guests
      errors.add(:base, "Maximum #{lodging.adults} adults are allowed") if lodging.adults.present? && lodging.adults.to_i < adults.to_i
      errors.add(:base, "Maximum #{lodging.adults_plus_children} guests are allowed") if lodging.adults_plus_children < adults.to_i + children.to_i
    end
