class CustomText < ApplicationRecord
  ...
  translates :h1_text, :p_text, :meta_title, :meta_description, :category, :seo_path, :seo_path_without_locale, :seo_path_without_country, :redirect_url, :country, :region, :experience
