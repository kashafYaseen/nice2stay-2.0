class Rule < ApplicationRecord
  ...
  scope :with_published_room_rates, -> { joins(rate_plan: { room_rates: :child_lodging }).where("room_rates.publish = true AND lodgings.published = true AND rate_plans.rate_enabled = true").distinct }
