module LodgingsHelper
  ...
  def image_tag_with_link lodging, image_path, options = {}
    link_to lodging_path(lodging, check_in: params[:check_in], check_out: params[:check_out], adults: params[:adults], children: params[:children]), class: "text-decoration-none" do
